...
/**
 * Criteria class for the {@link com.company.hrlite.domain.Employee} entity. This class is used
 * in {@link com.company.hrlite.web.rest.EmployeeResource} to receive all the possible filtering options from
...
public class EmployeeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, phone, hireDate, salary, active, addressId, departmentId, distinct);
    }
