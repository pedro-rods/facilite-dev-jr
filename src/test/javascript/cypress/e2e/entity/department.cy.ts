...
describe('Department e2e test', () => {
  ...
  const departmentSample = { name: 'at pfft' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="name"]`).type('brief');
      cy.get(`[data-cy="name"]`).should('have.value', 'brief');

      cy.get(`[data-cy="costCenter"]`).type('safely scarper');
      cy.get(`[data-cy="costCenter"]`).should('have.value', 'safely scarper');
