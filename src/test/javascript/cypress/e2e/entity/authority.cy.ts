...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '63fe7983-1e3f-4165-94a1-856ab6455551' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('abb1d767-1ea1-4a65-ba2b-ec4e5d37f21f');
      cy.get(`[data-cy="name"]`).should('have.value', 'abb1d767-1ea1-4a65-ba2b-ec4e5d37f21f');
