...
import static com.company.hrlite.domain.DepartmentAsserts.*;
import static com.company.hrlite.web.rest.TestUtil.createUpdateProxyForBean;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity() {
        return new Department().name(DEFAULT_NAME).costCenter(DEFAULT_COST_CENTER);
    }
    ...
    public static Department createUpdatedEntity() {
        return new Department().name(UPDATED_NAME).costCenter(UPDATED_COST_CENTER);
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).costCenter(UPDATED_COST_CENTER);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).costCenter(UPDATED_COST_CENTER);
