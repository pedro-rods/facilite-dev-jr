...
import static com.company.hrlite.domain.AddressAsserts.*;
...
import com.company.hrlite.domain.enumeration.Uf;
...
class AddressResourceIT {
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.number(UPDATED_NUMBER).uf(UPDATED_UF);
